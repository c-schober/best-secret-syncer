import { BASE_URL, COMPANY_ID, LOCALES } from "./const"
...
export const getApplyUrl = (jobId: string) => {
  return `${BASE_URL}/career?&company=${COMPANY_ID}&career_ns=job_application&career_job_req_id=${jobId}&jobPipeline=Direct`
}
